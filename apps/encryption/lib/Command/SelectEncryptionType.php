...
class SelectEncryptionType extends Command {
	...
	protected function execute(InputInterface $input, OutputInterface $output) {
		...
		$freshInstallation = ($this->config->getAppValue('encryption','userSpecificKey', '') === '') &&
		...
		if($encryptionType === "masterkey") {
			if ($freshInstallation) {
				...
				$output->writeln("Encryption type is already opted. It can be set only one time. Aborting operation.");
			}
			...
			if ($freshInstallation) {
				...
				$output->writeln("Encryption type already opted. It can be set only one time. Aborting operation.");
			}
		} else {
